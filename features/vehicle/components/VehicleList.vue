...
<template>
  <section class="list" aria-label="Vehicle search results">
    <div v-if="showNoResults" class="empty" role="status">
      <h2>No vehicles found</h2>
      <p>Try adjusting your filters to see more results.</p>
      <div class="illustration">
        <svg class="blob" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path
            fill="currentColor"
        ...
        <img src="~/assets/images/no-results.png" alt="No results found" class="image" />
      </div>
    </div>
